# This is a Claude implementation of Flash that works exactly like the Azure version, except
# we are trying to debug what is wrong. Same code style as flash_awsclaude.py, just debugging version
